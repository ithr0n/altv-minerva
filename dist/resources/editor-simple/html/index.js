...
natives.setEntityCoords(localPlayerId, playerPos.x, playerPos.y, playerPos.z, 1, 0, 0, 1);`;
...
function execute() {
	...
	if (errors.length > 0) {
		...
		alt.emit('log', 'errors in editor:')
		errors.forEach(e => alt.emit('log', JSON.stringify(e)))
		return;
	}
